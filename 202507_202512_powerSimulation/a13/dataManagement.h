...
public:
    ...
    struct measure_data {
        ...
        double voltageRMSVal;   //전압 전체 RMS
        double currentRMSVal;   //전류 전체 RMS
        double vFundRMSVal;    //전압 기본파  RMS
        double cFundRMSVal;    //전류 기본파 RMS
        double vHarmonicRMSVal; //전압 고조파 RMS
        double cHarmonicRMSVal; //전류 고조파 RMS
        double powerVal;        //전체 전력
    };
    ...
    struct phasor_data {
        ...
        // 고조파 Voltage
        int    vOrderUsed = 1;    // 전압 고조파 차수
        double hvReal = 0.0;
        double hvImag = 0.0;
        double hvMag  = 0.0;
        double hvPhaseDeg = 0.0;
...
private:
    ...
    double fundSumV = 0.0;     //전압 기본파 누적값
    double fundSumC = 0.0;     //전류 기본파 누적값
    double harmonicSumV = 0.0;  //전압 고조파 누적값
    double harmonicSumC = 0.0;  //전류 고조파 누적값
    ...
    std::deque<data> voltage_fund_data_queue; //전압 기본파 데이터
