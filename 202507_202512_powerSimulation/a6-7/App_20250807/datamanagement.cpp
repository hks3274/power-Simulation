...
//초당 사이클 수 변경
void dataManagement::setCyclePerSecond(int cyclePerSecond)
{
...
void dataManagement::captureData()
{
    ...
    // 3. sin 값을 계산
    double voltageVal = value * sin(angle * M_PI / 180.0);
    double currentVal = currentValue * sin((angle + currentPhaseDeg) * M_PI / 180.0);
