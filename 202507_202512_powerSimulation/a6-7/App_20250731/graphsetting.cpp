    ...
    :QDialog(parent), dataMng(dataMng)
{
...

    {
        ...
        QRadioButton* oneSampleBtn = new QRadioButton("1 Sample");
        QRadioButton* halfCycleBtn = new QRadioButton("Half Cycle");
        QRadioButton* fullCycleBtn = new QRadioButton("1 Cycle");
