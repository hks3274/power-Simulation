...
class MyApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.VSlider.setTickPosition(QSlider.TickPosition.TicksAbove)  # 눈금을 위쪽에 표시
        self.VSlider.setTickInterval(10)  # 눈금 간격
        ...
        self.sSlider.setTickPosition(QSlider.TickPosition.TicksAbove)  # 눈금을 위쪽에 표시
        self.sSlider.setTickInterval(10)  # 눈금 간격
        self.sSlider.move(350, 230)
