    ...
    , gSubWindow(new QMdiSubWindow())
{
    ...
    iSubWindow->setGeometry(0, 0, width() / 4, height());
    ...
    gSubWindow->setGeometry(width() / 4, 0, width() * 3 / 4, height());
...
void MainWindow::resizeEvent(QResizeEvent *event)
{
    ...
    iSubWindow->setGeometry(0, 0, width() / 4, height()); // width(), height()는 각 Qwidget의 크기를 의미함
    gSubWindow->setGeometry(width() / 4, 0, width() * 3 / 4, height());
}
