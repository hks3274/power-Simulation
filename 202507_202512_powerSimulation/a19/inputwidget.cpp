    ...
    : dataMng(dataMng) // 멤버 초기화 리스트,  클래스 내부에 있는 멤버 변수 dataMng를 매개변수 dataMng로 초기화
{
    ...
    // ===== 상 B =====
    {
        ...
        // 전압 B : 위상
        {
            ...
            vBPhaseSpin->setValue(dataMng.getIAPhaseDeg());
        ...
        // 전류 B : 위상
        {
            ...
            iBPhaseSpin->setValue(dataMng.getIAPhaseDeg());
    ...
    // ===== 상 C =====
    {
        ...
        // 전압 C : 위상
        {
            ...
            vCPhaseSpin->setValue(dataMng.getIAPhaseDeg());
        ...
        // 전류 C : 위상
        {
            ...
            iCPhaseSpin->setValue(dataMng.getIAPhaseDeg());
