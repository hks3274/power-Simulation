...
private:
    ...
    QVector<double> vABuffer;  // (voltage)
    QVector<double> cABuffer;  // (current)
    QVector<double> vBBuffer;  // (voltage)
    QVector<double> cBBuffer;  // (current)
    QVector<double> vCBuffer;  // (voltage)
    QVector<double> cCBuffer;  // (current)
