...
public:
    ...
    //실제 틱 간격
    double getDtSec() const {return dt_sec;}
    double getDtMs() const {return dt_sec * 1000.0; }

    double getCyclePerSecond() { return cyclePerSecond; }
    int getSamplePerCycle() { return samplePerCycle; }
    double getGraphWidth() {return gWidth;}
    double getInputFreq() {return frequency;}
